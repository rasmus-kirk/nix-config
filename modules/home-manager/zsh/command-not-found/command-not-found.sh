...
command_not_found_handle () {
    ...
    cmd=$1
    attrs=$(/nix/store/8l6xc7r0yldxdw0lbpdcgsvrn5qn9fqb-nix-index-with-full-db-0.1.9-unstable-2026-02-05/bin/nix-locate --minimal --no-group --type x --type s --whole-name --at-root "/bin/$cmd")
